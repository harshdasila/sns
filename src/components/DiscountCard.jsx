...
const OutOfStock = () =>{
    alert("The Product is out of Stock. Arriving Soon!");
};
  ...
  return (
    ...
    >
        ...
        <button onClick={OutOfStock} className='my-2 border border-white p-2 hover:bg-gray-800 hover:text-white ease-in'>
            PURCHASE NOW
        </button>
