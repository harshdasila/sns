  ...
  return (
    ...
    <div className='contact-us flex justify-center items-center bg-black pt-[4rem] pb-6'>
      <div className='contact-us-item lg:w-2/6 pl-5 ml-5'>
                <h1 className='text-white flex justify-center items-center text-[23px] font-weight-[600] border-b-2 border-blue w-4/5'>About Supply & Services</h1>
                <div className='text-white font-[400] text-[18px] mt-[22.75px] pb-3 leading-8'>
                We at Supply & Services work towards a unique goal of being the one stop destination for all kinds of printing needs for Home & Offices.
                </div>
        ...
        <div className='contact-us-item lg:w-2/6 pl-5 ml-5'>
                ...
                <div className='text-white font-[400] text-[18px] mt-5 pb-3 leading-[30px]'>
                    ...
                    <div className='flex items-center mb-3'>
                        ...
                        <div className='ml-5 '>
                            <div className=''>
                                General - info@supplyndservices.com
                            </div>
                            <div className=''>
                                Billing - billing@supplyndservices.com
                            </div>
                        </div>
                    </div>
                    <div className='flex  items-center mb-3'>
    ...
    <div className='contact-us-item text-white font-[400] text-[18px] mt-5 pb-3 leading-8'>
        <ul className='flex flex-col items-center'> {/* Apply flexbox styles here */}
            <Link to="/whyus"><li>Why Choose Us</li></Link>
